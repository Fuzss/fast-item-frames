...
import fuzs.fastitemframes.client.handler.ClientMenuProviderInteraction;
...
public class FastItemFramesClient implements ClientModConstructor {
    private static final BlockColor ITEM_FRAME_BLOCK_COLOR_PROVIDER = (BlockState blockState, @Nullable BlockAndTintGetter blockAndTintGetter, @Nullable BlockPos blockPos, int tintIndex) -> {
    ...
    private static void registerEventHandlers() {
        ...
        InteractionInputEvents.USE.register(EventPhase.BEFORE, ClientMenuProviderInteraction.INSTANCE::onUseInteraction);
    }
