package fuzs.fastitemframes.common.data.client;
...
public class ModModelProvider extends AbstractModelProvider {
    ...
    public static TextureMapping createItemFrameMapping(Material material) {
        return new TextureMapping().put(WOOD, ModelLocationHelper.getBlockTexture(Blocks.BIRCH_PLANKS))
                .put(TextureSlot.BACK, material)
    ...
    public final void createItemFrame(Block block, BlockModelGenerators blockModelGenerators) {
        Identifier blockModel = ModelLocationHelper.getBlockModel(Identifier.withDefaultNamespace(ModelLocationHelper.getBlockName(
                block)));
        Identifier mapModel = ModelLocationHelper.getBlockModel(Identifier.withDefaultNamespace(ModelLocationHelper.getBlockName(
                block)), "_map");
